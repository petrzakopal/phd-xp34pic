...
\end{equation}
where the $x_0$ is the initial value for the \gls{abbreviation:nr} algorithm, $D$ is the denominator value for calculating the expression $N/D$, where $N$ is the numerator.\pa
