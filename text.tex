...
\section{Selective Harmonic Elimination}
    ...
    \subsection{Simplification for Verilog and High level implementation}
        ...
        \begin{equation}
            \begin{gathered}
               F_1^i = m \; \frac{\pi}{4} = \cos(\alpha_1) - \cos(\alpha_2),\\
                F_2^i = 0 = \cos(5\alpha_1) - \cos(5\alpha_2).
            \end{gathered}
        \end{equation}
        ...
        \begin{equation}
            \begin{gathered}
                (\Delta \alpha^i) = (J_{\mathrm{inv}}^i) (\Delta F^i),
            \end{gathered}
        \end{equation}
        ...
        \begin{equation}
            \begin{gathered}
                \Delta \alpha_1^i = J_{00\mathrm{inv}}^i \Delta F_1^i + J_{01\mathrm{inv}}^i \Delta F_2^i,\\
                \Delta \alpha_1^2 = J_{10\mathrm{inv}}^i \Delta F_1^i + J_{11\mathrm{inv}}^i \Delta F_2^i.
            \end{gathered}
        \end{equation}
        ...
        It is important to mention, that for the \gls{abbreviation:nr} algorithm to work correctly, the suitable initial values $F_1^0$ and $F_2^0$ must be well chosen before the algorithm starts.
